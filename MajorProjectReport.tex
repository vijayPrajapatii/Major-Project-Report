...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{AI-Based Automated Log Analysis and Performance Evaluation System for Emulation-Based Software Testing}
\subCode{EC481P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Vijay Kumar Prajapati}
\stuUSNA{1RV22EC180}
...
%% External Guides
\guideNameB{Mr. Venkatarakesh Mamidi}
\guideDesignationB{Senior Staff Engineer}
\guideDeptB{Emulation \& Pre-Silicon Validation}
\guideOrgB{Qualcomm India Pvt. Ltd.}
...
\backgroundsetup{
  ...
  hshift=0pt,
  anchor=center,
  contents={\includegraphics[width=0.6\textwidth]{Figures/RVlogoVecW}}
}

%%%%%%%%%%%%%%%%%% Table row spacing %%%%%%%%%%%%%%%%%%
%% Adds breathing room above/below text inside every table cell.
