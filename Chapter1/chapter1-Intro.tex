...
\item The set of performance counters extracted (cycles, IPS, bandwidth, HMX/HVX/scalar counters, stalls, spill/fill bytes etc.) is fixed for the current release and matches the counters available on the platform under study.
