...
% IMAGE PLACEHOLDER: Insert flow diagram from PPT slide 14 (Data Collection: Test Execution -> Log Generation -> Log Ingestion -> Log Data Ready).
\begin{figure}[htb]
\centering
...
% IMAGE PLACEHOLDER: Insert flow diagram from PPT slide 15 (Log Processing: Preprocessing, Log Parsing (LogPAI - Drain), Feature Extraction -> Structured Logs / Feature Vectors).
\begin{figure}[htb]
\centering
	\includegraphics[scale=1]{Figures/universe}
...
% IMAGE PLACEHOLDER: Insert flow diagram from PPT slide 16 (Analysis Engine: Log Analysis (LogAI - ML), Metric Extraction, LLM Analysis).
\begin{figure}[htb]
\centering
	\includegraphics[scale=1]{Figures/universe}
...
% IMAGE PLACEHOLDER: Insert flow diagram from PPT slide 17 (Output and Delivery: Report Generation, Notification System).
\begin{figure}[htb]
\centering
	\includegraphics[scale=1]{Figures/universe}
...
\fontsize{10}{12}\selectfont
\centering
\caption{Performance parameters extracted from logs (Part 1 - throughput, memory, HMX/HVX, stalls, scalar)}
\label{tab:params1}
...
HMX\_MAC / HMX\_CVT & HMX Workload & HMX matrix / convert work packets\\\hline
HVX\_PKT & HVX Workload & HVX vector work packets\\\hline
HMX\_STALLS & Stall Analysis & HMX idle cycles (not doing useful work)\\\hline
HVX\_STALLS & Stall Analysis & HVX idle cycles\\\hline
...
hmx\_parallelism / hvx\_parallelism & multi\_calc & Average parallelism factor\\\hline
